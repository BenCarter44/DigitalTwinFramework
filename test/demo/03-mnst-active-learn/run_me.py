...
from model import HandwritingInvestigator
...
async def main():
    ...
    pubsub_client = await connect_stream_client("03-mnst-active-learn")
    ...
    runtime.add_investigator(investigator, CAMERA_DTYPE, DIGIT_DTYPE)
